<%-- 
    Document   : about
    Created on : May 27, 2023, 10:33:40 PM
    Author     : user
--%>
...
<body>
    ...
    <h1><center>About Style Haven...</center></h1>
<hr>
<div class="tab-content">
<p>
	<div class="container">
&nbsp;Welcome to our style haven shop! We are committed to giving you a fashionable and stylish shopping experience from the convenience of you
<br>
Thank you for visiting our Style haven store . We can't wait to be a part of your fashion adventure and help you find your next favorite outfit
</div>
</p>
</div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer__copyright__text">
                    <p> © Copyrights reserved | Style haven | 2022-2023 </p>
                </div>
            </div>
        </div>
    </div>
